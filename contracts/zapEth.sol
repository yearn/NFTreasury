...
contract EthZap {
    ...
    function deposit() public payable {
        ...
        if (wETH.allowance(address(this), address(vault)) < msg.value) {
            SafeERC20.safeApprove(wETH, address(vault), 0);
            SafeERC20.safeApprove(wETH, address(vault), type(uint256).max);
        }
    ...
    function withdraw(uint256 amount) public {
        ...
        uint256 wETHAmount = vault.withdraw(amount);
        require(wETHAmount != 0, "!amount");
