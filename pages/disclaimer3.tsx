                    ...
                    <div className={'flex justify-between mt-20'}>
                        <div>
                            <WithShadow role={'button'}>
                                <Button className={'w-[176px]'} onClick={(e: React.MouseEvent) => { e.preventDefault(); router.push('/disclaimer2') }}>
                                    {'Previous'}
                                </Button>
                            </WithShadow>
                        </div>
                        <div>
                            <WithShadow role={'button'}>
                                <Button className={'w-[176px]'} onClick={(e: React.MouseEvent) => { e.preventDefault(); router.push('/disclaimer4') }}>
                                    {'Next'}
                                </Button>
                            </WithShadow>
                        </div>
